# Agent Instructions for Transactions

## Project Context
Transactions is an open source ACID-like transactions for multi-agent operations.

## Repository Layout
- `src/aumai_transactions/` — package source
